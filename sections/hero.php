<div class="relative bg-gray-800 min-h-screen flex items-center">
    ...
    <div class="flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0">
        <!-- Get Started Button -->
        <a href="/views/signup.php" class="inline-block bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-8 rounded-lg shadow-lg transition duration-300 text-center">
            Go to Dashboard
        </a>

        <!-- Join WhatsApp Group Button -->
        <a href="https://chat.whatsapp.com/IFQGZ5Zd7j9DdR5sqGuawj" class="inline-block bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-8 rounded-lg shadow-lg transition duration-300 flex items-center justify-center">
