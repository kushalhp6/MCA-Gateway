...
$basePath = __DIR__ . "/"; // Points to the current directory 'exams3'
...
if ($examId && array_key_exists($examId, $examMapping)) {
    ...
    if (file_exists($fullPath)) {
        ...
        if ($submission && $submission['status'] === 'submitted') {
            header("Location: rules3.php?exam_id=" . urlencode($examId));
            exit;
        }
...
<div class="max-w-4xl mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
    ...
    <!-- Questions Form -->
    <form id="examForm" action="submit_exam3.php" method="POST">
        <?php foreach ($questions as $index => $question): ?>
