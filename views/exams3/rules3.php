...
$sql = "SELECT id FROM cards WHERE name = 'Module3'";
$stmt = $conn->prepare($sql);
$stmt->execute();
$stmt->bind_result($module3_card_id);
$stmt->fetch();
$stmt->close();

// Check if the user has 'Module3'
$has_module3_access = in_array($module3_card_id, $access_cards);

// Redirect if the user does not have access
if (!$has_module3_access && !$has_full_access) {
...
$examMapping = [
    'network_set_2' => 'networking/network_set_2.json',
    'network_set_3' => 'networking/network_set_3.json',
    'network_set_4' => 'networking/network_set_4.json',
    'network_set_5' => 'networking/network_set_5.json',
    'network_set_6' => 'networking/network_set_6.json',
    'network_set_7' => 'networking/network_set_7.json',
    'network_set_8' => 'networking/network_set_8.json',
    'network_set_9' => 'networking/network_set_9.json',
    'network_set_10' => 'networking/network_set_10.json',
    'dbms_set_2' => 'dbms/dbms_set_2.json',
    'dbms_set_3' => 'dbms/dbms_set_3.json',
    'dbms_set_4' => 'dbms/dbms_set_4.json',
    'dbms_set_5' => 'dbms/dbms_set_5.json',
    'dbms_set_6' => 'dbms/dbms_set_6.json',
    'dbms_set_7' => 'dbms/dbms_set_7.json',
    'dbms_set_8' => 'dbms/dbms_set_8.json',
    'dbms_set_9' => 'dbms/dbms_set_9.json',
    'dbms_set_10' => 'dbms/dbms_set_10.json',
    ...
    <div class="max-w-4xl mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
        ...
        <?php if ($isSubmitted && $submission !== null && $submission['status'] === 'submitted'): ?>
            ...
            <div class="flex justify-between mt-4">
                ...
                <a href="view_answers3.php?exam_id=<?= urlencode($examId) ?>" class="bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition-colors">
                    View Answers
                </a>
            </div>
        <?php else: ?>
            ...
            <div class="flex justify-between mt-4">
                ...
                <!-- Start Exam Button -->
                <a href="exam3.php?exam_id=<?= urlencode($examId) ?>" class="bg-blue-600 text-white py-2 px-6 rounded-lg hover:bg-blue-700 transition-colors">
                    Start Exam
                </a>
            </div>
        <?php endif; ?>
