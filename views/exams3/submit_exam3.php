...
$has_module3_access = in_array($card_ids['Module3'], $access_cards);
...
if (array_key_exists($examId, $examMapping)) {
    ...
    if (file_exists($fullPath)) {
        ...
        echo "<a href='rules3.php?exam_id=$examId' class='mt-4 inline-block px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700'>View Answers</a>";
        echo "</div>";
