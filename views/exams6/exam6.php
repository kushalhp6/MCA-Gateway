...
$basePath = __DIR__ . "/"; // Points to the current directory 'exams6'
...
if ($examId && array_key_exists($examId, $examMapping)) {
    ...
    if (file_exists($fullPath)) {
        ...
        if ($remainingTime <= 0) {
            ...
            header("Location: submit_exam6.php?exam_id=" . urlencode($examId));
            exit;
        }
        ...
        if ($submission && $submission['status'] === 'submitted') {
            header("Location: rules6.php?exam_id=" . urlencode($examId));
            exit;
        }
    } else {
...
<div class="max-w-6xl mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
    ...
    <!-- Questions Form -->
    <form id="examForm" action="submit_exam6.php" method="POST">
