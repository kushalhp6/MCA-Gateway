...
<div class="mb-10">
    ...
    <div class="mt-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div class="bg-blue-100 p-4 rounded-lg shadow-md flex flex-col items-center transform hover:scale-105 hover:bg-blue-200 transition-all duration-300">
                <span class="font-medium text-lg text-blue-800 mb-2">Operating System Set 1</span>
...
<div class="mb-10">
    ...
    <div class="mb-8">
        <h4 class="text-xl font-semibold mb-4 text-gray-700">Operating System Sets</h4>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <div class="bg-gray-800 p-4 rounded-lg shadow-lg hover:shadow-xl transition-transform transform hover:scale-105 flex justify-between items-center">
                <span class="text-lg font-bold text-white">Operating System Set 2</span>
            ...
            <div class="bg-gray-800 p-4 rounded-lg shadow-lg hover:shadow-xl transition-transform transform hover:scale-105 flex justify-between items-center">
                <span class="text-lg font-bold text-white">Operating System Set 3</span>
            ...
            <div class="bg-gray-800 p-4 rounded-lg shadow-lg hover:shadow-xl transition-transform transform hover:scale-105 flex justify-between items-center">
                <span class="text-lg font-bold text-white">Operating System Set 4</span>
                <a href="unix_set_3_link" class="bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition-colors">Start Exam</a>
            </div>
            <div class="bg-gray-800 p-4 rounded-lg shadow-lg hover:shadow-xl transition-transform transform hover:scale-105 flex justify-between items-center">
                <span class="text-lg font-bold text-white">Operating System Set 5</span>
                <a href="unix_set_3_link" class="bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition-colors">Start Exam</a>
            </div>
            <div class="bg-gray-800 p-4 rounded-lg shadow-lg hover:shadow-xl transition-transform transform hover:scale-105 flex justify-between items-center">
                <span class="text-lg font-bold text-white">Operating System Set 6</span>
                <a href="unix_set_3_link" class="bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition-colors">Start Exam</a>
            </div>
            <div class="bg-gray-800 p-4 rounded-lg shadow-lg hover:shadow-xl transition-transform transform hover:scale-105 flex justify-between items-center">
                <span class="text-lg font-bold text-white">Operating System Set 7</span>
                <a href="unix_set_3_link" class="bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition-colors">Start Exam</a>
            </div>
            <div class="bg-gray-800 p-4 rounded-lg shadow-lg hover:shadow-xl transition-transform transform hover:scale-105 flex justify-between items-center">
                <span class="text-lg font-bold text-white">Operating System Set 8</span>
                <a href="unix_set_3_link" class="bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition-colors">Start Exam</a>
            </div>
            <div class="bg-gray-800 p-4 rounded-lg shadow-lg hover:shadow-xl transition-transform transform hover:scale-105 flex justify-between items-center">
                <span class="text-lg font-bold text-white">Operating System Set 9</span>
            ...
            <div class="bg-gray-800 p-4 rounded-lg shadow-lg hover:shadow-xl transition-transform transform hover:scale-105 flex justify-between items-center">
                <span class="text-lg font-bold text-white">Operating System Set 10</span>
                <a href="unix_set_3_link" class="bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 transition-colors">Start Exam</a>
            </div>
        </div>
    </div>
...
<?php else: ?>
                    <div class="bg-red-600 p-6 rounded-lg shadow-lg">
                        <p class="mb-4">Unlock the premium section by purchasing Module2.</p>
