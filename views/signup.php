    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-900 px-4">
        <div class="w-full max-w-lg bg-gray-800 p-8 rounded-lg shadow-lg">
            ...
            if (isset($_GET['error'])) {
                ...
                // Display the corresponding error message based on the error type
                if ($error == 'email_exists') {
                    echo '<p class="text-red-500 text-center">This email is already registered. Please use a different email.</p>';
                } elseif ($error == 'invalid_email') {
                    echo '<p class="text-red-500 text-center">Invalid email format. Please enter a valid email address.</p>';
                } elseif ($error == 'invalid_whatsapp') {
                    echo '<p class="text-red-500 text-center">Invalid WhatsApp number. Please enter a 10-digit number.</p>';
                    ...
                    echo '<p class="text-red-500 text-center">Database error. Please contact support.</p>';
                }
            }
            ?>
